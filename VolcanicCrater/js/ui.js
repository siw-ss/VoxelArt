...
export function showLoaderError(title, detail) {
    ...
    ld.innerHTML =
        '<div style="font-size:17px;color:#FF6B35;margin-bottom:10px;">' + title + "</div>" +
...
export function initLavaPanel() {
    var btn = document.getElementById("lava-speed-btn");
    var panel = document.getElementById("lava-panel");
    if (!btn || !panel) return;
...
export function initTypewriter() {
    var text = "An active volcanic crater complex with molten lava flowing through obsidian channels, steam vents erupting from sulfur-stained chimneys, and crystalline mineral deposits glowing among basalt columns beneath an ash-laden sky.";
